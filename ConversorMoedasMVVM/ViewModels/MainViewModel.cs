...
public class MainViewModel : INotifyPropertyChanged
{
    ...
    // ICommand: interface que define um comando, que pode ser vinculado a elementos de interface do usuário, como botões.
    string _to = "BRL";
    public string To
    {
        get => _to;
    ...
    void DoConvert()
    {
        ...
        ResultText = string.Format(_pt, "{0:C2} {1} = {2:N2} {3}", amount, From, result, To);
    }
